...
def main():
    ...
    Personagem1.BlocoInventario.addItem(Arma("Revólver", "desc", {"Desastre": "0", "Falha": "0", "Normal": "1D10+2*", "Bom": "1D10+2+2*", "Extremo": "1D10+4+2*", "Crítico": "1D10+6+2*"}, "Armas de Fogo P"))
    ...
    for item_obj in window.items_array:
        item_obj.usb_use_signal.connect(lambda value: handle_item_use(Personagem1, window, value))
